<?php
/**
 * A model for managing Pysen modules.
 * 
 * @package PysenCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $pysenCoreModules = array('CPysen', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $pysenCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isPysenCore']   = in_array($rc->name, $this->pysenCoreModules);
      $details['isPysenCMF']    = in_array($rc->name, $this->pysenCMFModules);
